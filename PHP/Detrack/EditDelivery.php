<?php
	//Execute from command prompt as 'php EditDelivery.php'
	/* Define the delivery data that needs to update as an array of deliveries that will be send to api request*/
	$data = array(
	array(
      "date"=>date('Y-m-d'),
      "do"=>"DO140211001",
	...
	curl_setopt($connection, CURLOPT_URL, "https://app.detrack.com/api/v1/deliveries/update.json");
	...
	echo 'Do: ';
	echo $json['results'][0]['do']; //Access Individual property within Response. Response comes as array so use index / iterate thorugh array
