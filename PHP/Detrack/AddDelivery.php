<?php   
	//Execute from command prompt as 'php AddDelivery.php'
	/* Define the new delivery data (you can send array of deliveries in one request) that will be send to api request*/
	$data = array(
	array(
      "date"=>date('Y-m-d'),
      "do"=>"DO140211001",
	...
	//print_r($headerSent);
	//Decode the response as JSON object
